...
Since I already knew I wanted to build this, I decided to add some extra functions as well. I really wanted to make the editor as fast as possible, and since I'm building it in Rust I want to try to implement `async` as I don't want to have any actions that might freze the editor. 
